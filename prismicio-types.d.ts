...
interface NavigationDocumentData {
   ...
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: navigation.footerLinks
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  footerLinks: prismic.Repeatable<prismic.LinkField>;

  /**
   * Main Nav link field in *Navigation*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: navigation.mainNavLinks
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  mainNavLinks: prismic.Repeatable<prismic.LinkField>;

  /**
   * Main Nav Cta Link field in *Navigation*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: navigation.mainNavCtaLink
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  mainNavCtaLink: prismic.Repeatable<prismic.LinkField>;
}
...
interface SettingsDocumentData {
  ...
  /**
   * InstagramLink field in *Settings*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.instagramLink
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  ...
  /**
   * navLogo field in *Settings*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.navLogo
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  navLogo: prismic.ImageField<never> /**
...
/**
 * Item in *Hero → Default → Primary → backgrounds*
 */
export interface HeroSliceDefaultPrimaryBackgroundsItem {
  /**
   * Image field in *Hero → Default → Primary → backgrounds*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.backgrounds[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * backgrounds field in *Hero → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.backgrounds[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  backgrounds: prismic.GroupField<
    Simplify<HeroSliceDefaultPrimaryBackgroundsItem>
  >;
}
 ...
 */
export interface ImageSliceFullWidthPrimary {
  /**
   * Image field in *Image → Full Width → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: image.fullWidth.primary.image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ImageSliceFullWidth = prismic.SharedSliceVariation<
  "fullWidth",
  Simplify<ImageSliceFullWidthPrimary>,
  never
>;
 ...
 */
type ImageSliceVariation = ImageSliceDefault | ImageSliceFullWidth;
...
export interface TextWithImageSliceDefaultPrimary {
  ...
  /**
   * link field in *TextWithImage → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: text_with_image.default.primary.link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  link: prismic.LinkField;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      HeroSlice,
      HeroSliceDefaultPrimaryBackgroundsItem,
      HeroSliceDefaultPrimary,
      HeroSliceVariation,
      HeroSliceDefault,
      ImageSlice,
      ImageSliceDefaultPrimary,
      ImageSliceFullWidthPrimary,
      ImageSliceVariation,
      ImageSliceDefault,
      ImageSliceFullWidth,
      ImageCardsSlice,
